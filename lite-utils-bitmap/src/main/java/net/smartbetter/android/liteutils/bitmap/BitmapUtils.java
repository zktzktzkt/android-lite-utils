package net.smartbetter.android.liteutils.bitmap;
...
public class BitmapUtils {
     ...
     * @return
     */
    public byte[] bitmapToByte(Bitmap b, int quality) {
     ...
     * @return
     */
    public Bitmap getScaleBitmap(Resources res, int resId, int showWidth, int showHeight) {
    ...
    public Bitmap getScaleBitmap(String path, int showWidth, int showHeight) {
        BitmapFactory.Options options = getOptions();
        options.inJustDecodeBounds = true;
     ...
     * @return
     */
    private Bitmap getScaleBitmap(Bitmap bm, float showWidth, float showHeight) {
        if (bm == null) {
            return null;
        }
     ...
     * @return
     */
    public Bitmap flipBitmap(Bitmap bmp, int sx, int sy) {
        int w = bmp.getWidth();
        int h = bmp.getHeight();
        Matrix matrix = new Matrix();
     ...
     * @return
     */
    public Bitmap bitmapRotate(Bitmap bitmap, int degree) {
        Matrix matrix = new Matrix();
     ...
     * @return
     */
    public Bitmap createCircleImage(Bitmap source, int size) {
